...
import { GamepadIcon, Code, User, ArrowDown } from "lucide-react";
...
const sections = [
  ...
  },
  {
    id: "gaming",
    title: "Gaming World",
    description: "Xbox, Minecraft, and everything gaming",
    icon: GamepadIcon,
    color: "electric-blue", 
  ...
  },
  {
    id: "coding",
    title: "Code & Projects",
    description: "Building games, apps, and cool stuff",
    icon: Code,
    color: "matrix-teal",
...
export const TableOfContents = ({ onScrollToAbout }: TableOfContentsProps) => {
  return (
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {sections.map((section, index) => {
            ...
            return (
              <Card 
                key={section.id}
                className={`bg-gradient-to-br ${section.gradient} border ${section.border} ${section.shadow} hover:scale-105 transition-all duration-300 cursor-pointer animate-slide-up`}
