          ...
          <div className="relative inline-block mb-6">
            <div className="relative" style={{ width: '580px', height: '160px', margin: '0 auto' }}>
              <h1 className="text-6xl md:text-8xl font-black absolute" style={{ fontFamily: 'Impact, Arial Black, sans-serif' }}>
                <span className="bg-cyber-cyan text-black px-4 py-2 absolute" style={{ top: '-35px', left: '0px' }}>MIKAAL</span>
                <span className="bg-cyber-cyan text-black px-4 py-2 absolute" style={{ top: '55px', left: '305px' }}>KHAN</span>
              </h1>
            </div>
          </div>
